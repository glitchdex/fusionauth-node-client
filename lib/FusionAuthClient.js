...
FusionAuthClient.prototype = {
   ...
   * @return {Promise} A Promise for the FusionAuth call.
   */
  createUserConsentType: function(consentTypeId, request) {
    return new Promise((resolve, reject) => {
      this._start()
   ...
   * @return {Promise} A Promise for the FusionAuth call.
   */
  deleteUserConsentType: function(consentTypeId) {
    return new Promise((resolve, reject) => {
      this._start()
          .uri('/api/user/consent/type')
          .urlSegment(consentTypeId)
   ...
   * @return {Promise} A Promise for the FusionAuth call.
   */
  retrieveUserConsent: function(consentId) {
    return new Promise((resolve, reject) => {
      this._start()
   ...
   * @return {Promise} A Promise for the FusionAuth call.
   */
  retrieveUserConsentType: function(userConsentTypeId) {
    return new Promise((resolve, reject) => {
      this._start()
          .uri('/api/user/consent/type')
   ...
   * @return {Promise} A Promise for the FusionAuth call.
   */
  retrieveUserConsentTypes: function() {
    return new Promise((resolve, reject) => {
      this._start()
          .uri('/api/user/consent/type')
          .get()
   ...
   * @return {Promise} A Promise for the FusionAuth call.
   */
  revokeUserConsent: function(consentId) {
    return new Promise((resolve, reject) => {
      this._start()
          .uri('/api/user/consent')
          .urlSegment(consentId)
   ...
   * @return {Promise} A Promise for the FusionAuth call.
   */
  updateUserConsent: function(consentId, request) {
    return new Promise((resolve, reject) => {
      this._start()
          .uri('/api/user/consent')
          .urlSegment(consentId)
   ...
   * @return {Promise} A Promise for the FusionAuth call.
   */
  updateUserConsentType: function(consentTypeId, request) {
    return new Promise((resolve, reject) => {
      this._start()
          .uri('/api/user/consent/type')
          .urlSegment(consentTypeId)
